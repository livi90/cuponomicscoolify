...
DROP POLICY IF EXISTS "Administradores pueden eliminar tiendas" ON stores;
...
-- Política para permitir a CUALQUIER ROL insertar tiendas (temporal para depuración)
CREATE POLICY "Cualquiera puede insertar tiendas" ON stores

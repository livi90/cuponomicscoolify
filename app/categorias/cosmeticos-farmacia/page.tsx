...
export default function CosmeticosFarmaciaPage() {
  ...
  const popularProducts = [
    "L'Oréal base maquillaje",
    "Nivea crema hidratante",
    "Chanel perfume",
    "The Ordinary serum",
    "Maybelline máscara",
    "La Roche Posay protector",
    "Eucerin crema",
    "MAC lipstick"
  ]
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-2xl">
                ...
                <p className="text-xl text-white/90 mb-8">
                  Belleza, cuidado personal y productos de farmacia a los mejores precios
                </p>
                ...
                <div className="relative group">
                  <div className="flex items-center bg-transparent group-hover:bg-white/20 backdrop-blur-sm rounded-full shadow-xl border border-white/30 group-hover:border-white/50 overflow-hidden transition-all duration-300 opacity-70 group-hover:opacity-100">
                                         <HybridSearchBar
                       placeholder="Buscar cosméticos o productos de farmacia... Ej: L'Oréal, Nivea, Chanel..."
                       onSearch={(query: string) => {
                         // Redirigir a la página de búsqueda híbrida
                         window.location.href = `/busqueda-hibrida?q=${encodeURIComponent(query)}`
                       }}
                       className="flex-1 border-0 text-lg py-6 px-4 focus:ring-0 focus:outline-none bg-transparent text-white placeholder:text-white/90 transition-colors duration-300"
                     />
                  </div>
                </div>
              </div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl p-8 text-white text-center">
          <h2 className="text-3xl font-bold mb-4">Tu belleza al mejor precio</h2>
          <p className="text-orange-100 mb-6 text-lg">
            Encuentra los mejores precios en cosméticos, perfumes y productos de farmacia
          </p>

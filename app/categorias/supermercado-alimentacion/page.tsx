...
export default function SupermercadoAlimentacionPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-64">
        <img
          src="/Imagenes landing/imagens cada categoría/Supermercado & Alimentación/banner.png"
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-4xl lg:text-5xl font-bold mb-4">Supermercado & Alimentación</h1>
            <p className="text-lg lg:text-xl opacity-90 max-w-2xl">
              Encuentra las mejores ofertas en comida, bebidas y productos frescos
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="max-w-2xl mx-auto">
            <HybridSearchBar 
              placeholder="Buscar productos de alimentación..."
        ...
        <section className="bg-white rounded-lg shadow-sm p-8 text-center">
          <h2 className="text-2xl font-bold mb-4">¿Listo para hacer la compra?</h2>
          <p className="text-gray-600 mb-6">
            Compara precios de productos de alimentación y encuentra las mejores ofertas
          </p>
          <Button 
            size="lg" 
